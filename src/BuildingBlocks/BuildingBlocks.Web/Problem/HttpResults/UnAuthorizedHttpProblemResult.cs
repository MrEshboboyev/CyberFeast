...
/// <summary>
/// Represents an HTTP result for a 401 Unauthorized response with a problem details object.
/// </summary>
public class UnAuthorizedHttpProblemResult : IResult, IStatusCodeHttpResult, IContentTypeHttpResult, IValueHttpResult,
    IEndpointMetadataProvider
{
    private readonly ProblemHttpResult _internalResult;

    /// <summary>
    /// Initializes a new instance of the <see cref="UnAuthorizedHttpProblemResult"/> class.
    /// </summary>
    ...
    /// <exception cref="ArgumentException">Thrown if the status code is not 401 Unauthorized.</exception>
