...
{
    // EF
    // this constructor is needed when we have a parameter constructor that has some
    // navigation property classes in the parameters and ef will skip it and try to find
    // other constructor, here default constructor (maybe will fix .net 8)
    private Category() { }
    ...
    {
        // Alexey Zimarev book: input validation will do in the `command` and our
        // `value objects` before arriving to entity and makes or domain cleaner (but
        // we have to check against for our value objects), here we just do business
        // validation
    ...
    {
        // input validation will do in the command and our value objects, here we just do
        // business validation
