...
namespace FoodDelivery.Services.Customers.RestockSubscriptions.Data;
...
public class RestockSubscriptionEntityConfiguration : IEntityTypeConfiguration<RestockSubscription>
{
    ...
    {
        builder.ToTable(
            nameof(RestockSubscription).Pluralize().Underscore(), 
        ...
        builder.OwnsOne(
            ...
            a =>
            {
                ...
                a.Property(p => p.Value)
                    .HasColumnName(nameof(RestockSubscription.Email)
                        .Underscore());
            }
        );
