...
{
    // If this handler is called successfully, it will send an ACK to rabbitmq for removing message from the queue and if we have an exception it send an NACK to rabbitmq
