    ...
    : IntegrationTestBase<CustomersApiMetadata, CustomersDbContext, CustomersReadDbContext>
{
    ...
    public IdentityServiceWireMock IdentityServiceWireMock
    {
        get
        {
            if (_identityServiceWireMock is not null) return _identityServiceWireMock;
    ...
    public CatalogsServiceWireMock CatalogsServiceWireMock
    {
        get
        {
            if (_catalogsServiceWireMock is not null) return _catalogsServiceWireMock;
        ...
        : base(sharedFixture, outputHelper)
    {
        ...
        // note2: add in-memory configuration instead of using appsettings.json and override existing settings, and it is accessible via IOptions and Configuration
