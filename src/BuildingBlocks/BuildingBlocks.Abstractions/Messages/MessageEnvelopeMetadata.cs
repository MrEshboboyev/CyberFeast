...
public record MessageEnvelopeMetadata(
    ...
    // In simple terms, it's used to see what causes what.
    // The first message in a message conversation typically doesn't have a causation ID.
    // Downstream messages get their causation IDs by copying message IDs from messages,
    // causing downstream messages to be published
    Guid? CausationId
)
{
