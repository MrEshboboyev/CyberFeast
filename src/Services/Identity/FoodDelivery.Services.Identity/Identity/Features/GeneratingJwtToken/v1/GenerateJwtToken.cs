...
internal record GenerateJwtToken(
    ApplicationUser User, 
    string RefreshToken) : ICommand<GenerateJwtTokenResult>
{
    /// <summary>
...
{
    public async Task<GenerateJwtTokenResult> Handle(
        GenerateJwtToken request, CancellationToken cancellationToken)
    {
        request.NotBeNull();
