...
public class Brand : Aggregate<BrandId>
{
    ...
    {
        // input validation will do in the `command` and our `value objects` before arriving to
        // entity and makes or domain cleaner (but we have to check against for our value objects),
        // here we just do business validation
        id.NotBeNull();
        name.NotBeNull();
