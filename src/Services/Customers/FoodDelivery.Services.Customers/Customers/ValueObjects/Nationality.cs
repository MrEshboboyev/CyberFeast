...
public record Nationality
{
    ...
    // Note: in entities with none default constructor, for setting constructor parameter,
    // we need a private set property
    // when we didn't define this property in fluent configuration map,
    // because for getting mapping list of properties to set
