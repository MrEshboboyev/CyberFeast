...
/// <summary>
/// Could filter by `dotnet test --filter "Category=Bug"` and `dotnet test --filter "Bug=201"`
/// in running tests in command line
/// </summary>
[TraitDiscoverer(BugTraitDiscoverer.DiscovererTypeName, XunitConstants.AssemblyName)]
[AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, AllowMultiple = true)]
public class BugTraitAttribute(int id) : Attribute, ITraitAttribute
{
