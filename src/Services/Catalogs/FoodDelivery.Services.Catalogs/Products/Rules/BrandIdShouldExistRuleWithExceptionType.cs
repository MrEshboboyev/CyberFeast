...
public class BrandIdShouldExistRuleWithExceptionType(
    [NotNull] IBrandChecker? brandChecker, 
    [NotNull] BrandId? id) : IBusinessRuleWithExceptionType<BrandNotFoundException>
{
