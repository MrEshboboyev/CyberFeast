...
/// <summary>
/// Represents an HTTP result for a 500 Internal Server Error response with a problem details object.
/// </summary>
public class InternalHttpProblemResult : IResult, IStatusCodeHttpResult, IContentTypeHttpResult, IValueHttpResult,
    IEndpointMetadataProvider
{
    private readonly ProblemHttpResult _internalResult;

    /// <summary>
    /// Initializes a new instance of the <see cref="InternalHttpProblemResult"/> class.
    /// </summary>
    ...
    /// <exception cref="ArgumentException">Thrown if the status code is not 500 Internal Server Error.</exception>
    ...
    public static void PopulateMetadata(MethodInfo method, EndpointBuilder builder)
    {
        ...
        builder.Metadata.Add(new ProducesResponseTypeAttribute(typeof(ProblemDetails),
