...
public class CustomerEntityTypeConfiguration : IEntityTypeConfiguration<Customer>
{
    ...
    {
        builder.ToTable(
            nameof(Customer).Pluralize().Underscore(), 
            CustomersDbContext.DefaultSchema);
        ...
        builder.OwnsOne(
            ...
            a =>
            {
                a.Property(p => p.Value)
                    ...
                    .IsRequired()
                    .HasMaxLength(EfConstants.Length.Medium);
        ...
        builder.OwnsOne(
            ...
            a =>
            {
                a.Property(p => p.Value)
                    ...
                    .IsRequired()
                    .HasMaxLength(EfConstants.Length.Tiny);
        ...
        builder.OwnsOne(
            ...
            a =>
            {
                a.Property(p => p.City).HasMaxLength(EfConstants.Length.Short);
                a.Property(p => p.Country).HasMaxLength(EfConstants.Length.Medium);
                a.Property(p => p.Detail).HasMaxLength(EfConstants.Length.Medium);
